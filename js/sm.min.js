			...
			return g.setValue = function(a, b) {
				...
				if (!m.divider) {
					...
					m.replaceValues = function(a, b) {
						...
						var b, c;
						b = 0, c = m.container[0].offsetHeight, n = m.wrapper[0].offsetHeight, o = m.items[0].offsetHeight, p = o * m.items.length, q = c / 2 - p + o / 2, r = c / 5 - o / 2, m.width && (b = m.width, parseInt(b, 10) === b && (b += "px"), m.container.css({
							width: b
